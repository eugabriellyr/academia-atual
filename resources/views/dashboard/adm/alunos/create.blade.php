                            ...
                            <form class="" action="" method="post" novalidate>
                                <div class="teste">
                                    <div class="bloco">
                                        ...
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3">Data de Nasc<span
                                                    class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                        ...
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3">Confirme seu
                                        ...
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3">Altura<span
                                                    class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                        ...
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3">Peso<span
                                                    class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                        ...
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3">Plano<span
                                                    class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                ...
                                <div class="bloco">
                                    ...
                                    <div class="field item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <input class="form-control" data-validate-length-range="6"
                                                data-validate-words="2" name="nome"
                                    ...
                                    <div class="field item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3">Telefone<span
                                                class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6">
                                            <input class="form-control" type="text" class='number'
                                                name="telefone" data-validate-minmax="8,20" required='required'>
                                        </div>
                                    </div>
                                    ...
                                    <div class="field item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3">message<span
                                                class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6">
