        ...
        <div class="main_container">
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    @if(session('tipoUsuario') == 'administrativo' && session('cargoFuncionario') == 'administrador')
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                <li><a href="#"><i class="fa fa-home"></i> Perfil <span class="fa fa-chevron-down"></span></a>
                                    {{-- <ul class="nav child_menu">
                                        <li><a href="{{ route('admin.func.index') }}">Sub para teste</a></li>
                                    </ul> --}}
                                </li>
                                <li><a href="{{ route('dashboard.adm.alunos.index') }}"><i class="fa fa-edit"></i> Alunos <span class="fa fa-chevron-down"></span></a>
                                    {{-- <ul class="nav child_menu">
                                        <li><a href="form.html">Sub para teste</a></li>
                                    </ul> --}}
                                </li>

                                <li><a><i class="fa fa-table"></i> Funcionários <span
                                            class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="tables.html">Sub para teste</a></li>
                                    </ul>
                                </li>
                                <li><a><i class="fa fa-bar-chart-o"></i> Treinos <span
                                            class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                ...
                                <li><a><i class="fa fa-clone"></i>Cronograma <span
                                            class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                ...
                                <li><a><i class="fa fa-clone"></i>Pendências <span
                                            class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="fixed_sidebar.htmlF">Sub para teste</a></li>
                                    </ul>
